...
export default function AboutBanner() {
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M-100 220 C200 40 350 380 650 220 C900 90 1150 320 1540 180"
          stroke="#F6F0E8"
          strokeWidth="2"
          fill="none"
          strokeLinecap="round"
        ...
        />
        <path
          d="M-100 650 C250 500 350 800 750 650 C1000 550 1250 720 1540 600"
          stroke="#F6F0E8"
          strokeWidth="2"
          fill="none"
          strokeLinecap="round"
        />
        <path
          d="M250 -50 C350 120 250 260 450 400 C600 520 550 700 720 900"
          stroke="#F6F0E8"
          strokeWidth="1.5"
          fill="none"
          strokeLinecap="round"
      ...
      <div className="absolute top-[15%] left-[8%] h-4 w-4 rounded-full border border-[#F0E5D1]/15" />
      <div className="absolute top-[70%] right-[12%] h-6 w-6 rounded-full border border-[#F0E5D1]/10" />
      <div className="absolute top-[25%] right-[22%] h-3 w-3 rounded-full bg-[#F0E5D1]/10" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-10 sm:mb-12 md:mb-14">
            <div className="relative flex justify-center">
              ...
              <motion.div
                animate={{
                  width: `${(active / (stories.length - 1)) * 84}%`,
                }}
              ...
              <div className="flex items-start justify-between w-full max-w-4xl">
                {stories.map((story, index) => (
                  <button
                    ...
                    className="relative flex flex-col items-center gap-2 sm:gap-3 z-10"
                  >
                    <motion.div
                      animate={active === index ? { scale: [1, 1.15, 1] } : {}}
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage: `radial-gradient(circle, #F0E5D1 0.8px, transparent 0.8px)`,
                  backgroundSize: "12px 12px",
                }}
              />

              {/* Top Reflection */}
              <div className="absolute -top-24 -left-24 h-[320px] w-[320px] rotate-[18deg] bg-[#F0E5D1]/12 blur-[90px]" />

              {/* Moving Glass Sweep */}
              <motion.div
                animate={{ x: ["-180%", "250%"] }}
                transition={{ duration: 5, repeat: Infinity, ease: "linear" }}
                className="absolute top-0 h-full w-[140px] rotate-[15deg] bg-[#F0E5D1]/10 blur-[35px]"
              />

              {/* Top Right Glow */}
              <div className="absolute -right-24 -top-24 h-[300px] w-[300px] rounded-full bg-[#F0E5D1]/8 blur-[120px]" />
              ...
              <motion.div
                ...
                className="absolute left-0 bottom-0 h-[240px] w-[240px] rounded-full bg-[#F0E5D1]/10 blur-[100px]"
              />

              {/* Inner Glass Border */}
              <div className="absolute inset-[1px] rounded-[23px] sm:rounded-[31px] md:rounded-[39px] border border-[#F0E5D1]/5 pointer-events-none" />

              {/* Top Shine Line */}
              <div className="absolute left-8 right-8 top-0 h-px bg-gradient-to-r from-transparent via-[#F0E5D1]/30 to-transparent" />
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 items-center">
                ...
                <div className="flex justify-center">
                  {/* COFFEE CHAPTER */}
                  {active === 2 ? (
                    <div className="relative h-[200px] w-[220px] sm:h-[260px] sm:w-[280px] md:h-[320px] md:w-[340px]">
                      {/* Glow */}
                      <div
                        className="
                          absolute
                    ...
                    <motion.img
                      ...
                      src={stories[active].image}
                      alt=""
                      className="max-h-[170px] sm:max-h-[210px] md:max-h-[260px] object-contain"
                    />
                  )}
                </div>
